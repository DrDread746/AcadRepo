    ...
    <div className="min-h-screen px-4 py-8 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="text-muted mb-6">
          ...
          <span className="text-text">Faculty Dashboard</span>
        </nav>
        ...
        <div className="mb-8">
          ...
          <p className="text-muted">Manage resources and announcements for students.</p>
        </div>
          ...
          <div className="bg-surface p-6 rounded-xl shadow-lg border border-border mb-8">
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-muted mb-2 font-medium">Type</label>
                  <select
                ...
                <div>
                  <label className="block text-muted mb-2 font-medium">Subject</label>
                  <select
              ...
              <div>
                <label className="block text-muted mb-2 font-medium">Upload PDF File</label>
                <input
                  type="file"
                  accept=".pdf"
              ...
              <div>
                <label className="block text-muted mb-2 font-medium">File URL (optional)</label>
                <input
                  type="url"
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="verified" className="text-muted font-medium">Mark as verified</label>
              </div>
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="bg-surface hover:bg-border text-text font-semibold py-2 px-6 rounded-lg transition-colors"
                >
                  Cancel
                </button>
              </div>
            ...
            <form onSubmit={handleCreateAnnouncement} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 bg-background border border-border rounded-lg text-text focus:outline-none focus:border-primary h-24 transition-colors"
                  required
                />
              </div>
              <div className="flex gap-4">
        ...
        <div className="bg-surface p-6 rounded-xl shadow-lg border border-border">
          ...
          <div className="space-y-4">
            {announcements.length === 0 ? (
              <div className="text-muted text-center py-8">No announcements</div>
            ) : (
              announcements.map(announcement => (
                <div key={announcement.id} className="bg-background p-4 rounded-xl border border-border hover:bg-surface transition-colors">
                  <h3 className="text-lg font-semibold text-text mb-2">{announcement.title}</h3>
